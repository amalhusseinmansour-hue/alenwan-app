// lib/views/cartoons/all_cartoons_screen.dart
...
import 'cartoons_content.dart';

class AllCartoonsScreen extends StatelessWidget {
  const AllCartoonsScreen({super.key});
      ...
      title: Row(
        children: [
          ...
          Row(
            children: [
              IconButton(
                icon: const Icon(Icons.search, color: ProfessionalTheme.textPrimary, size: 22),
                onPressed: () {},
              ),
              IconButton(
                icon: const Icon(
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => CartoonController()..loadCartoons()),
